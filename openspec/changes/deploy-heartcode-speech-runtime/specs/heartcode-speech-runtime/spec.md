...
The system SHALL retain LiteLLM as the normal authentication, virtual-key
accounting, rate-limit, model-routing, retry, cooldown, and fallback plane, and
SHALL keep the PEA metering proxy private to the speech data path.
