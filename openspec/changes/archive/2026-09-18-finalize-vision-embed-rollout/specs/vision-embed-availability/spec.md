...
<!-- reconciled 2026-09-18 at triage: rewritten from cutover wording to steady state; the one-time "Rollback restores the prior proxy state" requirement was dropped (verified by design only, never exercised). -->
