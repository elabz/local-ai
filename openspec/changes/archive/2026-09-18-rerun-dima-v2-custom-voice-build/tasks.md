...
## Triage closure (2026-09-18, project-health-improvements): ABANDONED

Owner decision 2026-09-18: none of the Dima voice trials qualified. This line of inquiry is abandoned, and custom Kokoro voices will be approached differently in a future change. Archived with `--skip-specs`: none of this change's requirements were merged into the main specs, and its unchecked tasks will not be done. Nothing on PEA was changed at triage; `cv_custom_dima` (v1) is still listed by `pea-speech-tts`.
