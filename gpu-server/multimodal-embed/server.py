...
embedder: MultimodalEmbedder = MultimodalEmbedder()
...
app = FastAPI(
    title="HeartCode Multimodal Embedding Server",
    description="nomic-embed-multimodal-3b (BiQwen2.5) embeddings for Pascal GPUs",
    version="1.0.0",
    lifespan=lifespan,
)
