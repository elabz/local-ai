...
from embed_model import VisionEmbedder
...
embedder: VisionEmbedder = VisionEmbedder()
...
app = FastAPI(
    title="HeartCode Vision Embedding Server",
    description="nomic-embed-vision-v1.5 + nomic-embed-text-v1.5 (shared 768-d) for Pascal GPUs",
    version="1.0.0",
    lifespan=lifespan,
)
